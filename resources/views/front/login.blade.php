              ...
              {{-- Display message end --}}
                <form  id="loginForm" method="POST" action="{{url('front/login')}}" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="email" name="email" class="form-control" id="staticinputEmail">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-2 mr-sm-2">
                                <input type="password" name="password" class="form-control" id="inputsPassword">
                        ...
                        <div class="col-md-6 offset-md-3">
                            <div class="login-form-links">
                                ...
                                <div class="sign-btn">
                                    ...
                                    <a href="login/facebook" class="btn btn-primary"> <span><i class="bi bi-facebook"></i></span> Login with Facebook</a>
                                </div>
                            </div>
                        </div>
                    </div>
