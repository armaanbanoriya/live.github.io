                ...
                <div class="tab-content" id="myaccountContent">
                        ...
                        <div class="myaccount-content">
                            ...
                            <div class="myaccount-table table-responsive text-center">
                                <table class="table table-bordered">
                                    ...
                                    @foreach ( $orproducts as $orproduct )
                                        
                                    
                                    @foreach ($orproduct->orderproducts as $item)
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <img src=" {{ '/upload/'.$item->product_image}}" height="160px;" width="100px;" alt=""> </td>
                                            <td><a href="{{'invoice/'.$item->id}}" class="ht-btn black-btn">View</a>
                                            </td>
                                        </tr> 
                    ...
                    <div class="tab-pane fade" id="address-edit" role="tabpanel">
                        <div class="myaccount-content">
                            ...
                            @foreach ($address as $orderspro)
                                
                           
                            <address>
                                <p><strong>{{$orderspro->name}}</strong></p>
                                <p>{{$orderspro->address}} <br>
                                    {{$orderspro->city}},{{$orderspro->pincode}}</p>
                                <p>Mobile: {{$orderspro->phone}}</p>
                            </address>
                            @endforeach
                        ...
                        <div class="myaccount-content">
                            ...
                            <div class="account-details-form">
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-12 mb-30">
                                            <input id="password-confirm" name="password" placeholder="Current Password" type="password">
                                        </div> --}}
                                        ...
                                        <div class="col-lg-6 col-12 mb-30">
                                            <input id="password-confirm" name="new_confirm_password" placeholder="Confirm Password" type="password">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn theme-btn--dark1 btn--md">Save
                                                Changes</button>
                                        </div>
                                       </form>
                                    </div>
